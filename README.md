# Olá, eu sou Laerson Hammes 👋

💻 Desenvolvedor Python apaixonado por tecnologia, arquitetura de software, infraestrutura, redes e segurança da informação.

Tenho experiência no desenvolvimento de aplicações web, automações, APIs REST, observabilidade e soluções voltadas à infraestrutura. Sou um profissional autodidata que gosta de entender como as coisas funcionam por trás dos bastidores, desde aplicações backend até protocolos de rede.
...
- APIs REST
- Observabilidade (OpenTelemetry e Grafana)
- Infraestrutura Linux
- Docker e NGINX
- Redes e Segurança da Informação
- Inteligência Artificial e Agentes com LLMs
...
![Scapy](https://img.shields.io/badge/Scapy-1E90FF?style=for-the-badge)
...
<a href="https://www.instagram.com/laerson.hammes/">
